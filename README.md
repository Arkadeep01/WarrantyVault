...
---<img width="512" height="288" alt="image" src="https://github.com/user-attachments/assets/a21643df-513f-4992-8613-2a638debeaed" />
<div align="center">
...
View your app in AI Studio: https://ai.studio/apps/fcc89fb5-5a1b-4fe3-a35b-2e38782c73b1
...
🔗 **Live Deployment:** [warranty-vault-beta.vercel.app](https://warranty-vault-beta.vercel.app)
...
- ⚡ **Fast & Responsive UI:** Built with Vite, React, and TypeScript for instantaneous page loads and smooth interactions.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/Arkadeep01/WarrantyVault.git](https://github.com/Arkadeep01/WarrantyVault.git)
   cd WarrantyVault
